export FF_PATH=/etinfo/users2/tyunyayev/workspace/f-stack
...
bash ./configure --prefix=/etinfo/users2/tyunyayev/workspace/f-stack/install/usr/local/nginx_fstack --with-ff_module --with-debug
make
sudo make install
